...
//
// The "workers_observability", "user_details", "account_analytics", and
// "workers_queues" keys follow the same snake_case pattern as the other
// confirmed keys here, but — unlike "workers_scripts" — haven't been checked
// against an official example. If a row doesn't show up pre-filled on the
// token page, add it by hand.
